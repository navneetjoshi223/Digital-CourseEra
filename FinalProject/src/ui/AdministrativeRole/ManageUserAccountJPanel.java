...
public class ManageUserAccountJPanel extends javax.swing.JPanel {
    ...
    private  String validateUsername(String username) {
        ...
        if (!username.matches("^[a-zA-Z0-9_]+$")) {
            return "Invalid characters in the username. Please use alphanumeric characters and underscores.";
        }

        return null; // No errors, input is valid
    }
    ...
    private  String validatePassword(String password) {
        ...
        // Check the password criteria with at least one uppercase, one lowercase, and one special character
        if (!password.matches("^(?=.*[a-z])(?=.*[A-Z])(?=.*[!@#\\$%^&*\\(\\)_+\\-=\\[\\]\\{\\}|;:'\",.<>?/])[a-zA-Z!@#\\$%^&*\\(\\)_+\\-=\\[\\]\\{\\}|;:'\",.<>?/\\d]{8,}$")) {
            return "Invalid password. It must be at least 8 characters long and contain at least one uppercase letter, one lowercase letter, and one special character.";
        }
    ...
    private void initComponents() {
        ...
        tblUsers.setBackground(new java.awt.Color(51, 255, 255));
        ...
        add(jScrollPane1);
        jScrollPane1.setBounds(40, 140, 331, 296);

        grpNewUser.setBackground(new java.awt.Color(153, 153, 255));

        btnCreateUser.setBackground(new java.awt.Color(204, 204, 255));
        btnCreateUser.setFont(new java.awt.Font("Helvetica Neue", 1, 12)); // NOI18N
                    ...
                    .addGroup(grpNewUserLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        ...
                        .addGroup(grpNewUserLayout.createSequentialGroup()
                            ...
                            .addGroup(grpNewUserLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                .addComponent(cmbRoles, 0, 146, Short.MAX_VALUE)
        ...
        add(grpNewUser);
        grpNewUser.setBounds(387, 77, 388, 361);
    ...
    private void btnCreateUserActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateUserActionPerformed
        ...
        if (usernameValidationResult != null) {
            JOptionPane.showMessageDialog(this, usernameValidationResult);
            return;
        }
        
        String passwordValidationResult = validatePassword(password);
        if (passwordValidationResult != null) {
            JOptionPane.showMessageDialog(this, passwordValidationResult);
            return;
        }
